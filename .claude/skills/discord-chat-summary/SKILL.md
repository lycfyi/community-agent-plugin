...
First, read the manifest to understand what data is available:

```
Read file: data/manifest.yaml
```
...
**Claude:**
1. Reads `data/manifest.yaml` to list available servers
2. Reads all `messages.md` files
...
**Claude:**
1. Reads `data/manifest.yaml`
2. Finds Midjourney server directory
...
**Claude:**
1. Reads `data/manifest.yaml` to find #general channel path
...
- At least one server/channel should have data in `data/` directory
